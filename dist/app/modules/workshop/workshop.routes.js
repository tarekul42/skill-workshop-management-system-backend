...
router.post("/create", rateLimiter_1.adminCrudLimiter, (0, checkAuth_1.default)(user_interface_1.UserRole.ADMIN, user_interface_1.UserRole.SUPER_ADMIN), (0, validateRequest_1.default)(workshop_validation_1.createWorkshopZodSchema), workshop_controller_1.default.createWorkshop);
router.patch("/:id", rateLimiter_1.adminCrudLimiter, (0, checkAuth_1.default)(user_interface_1.UserRole.ADMIN, user_interface_1.UserRole.SUPER_ADMIN), (0, validateRequest_1.default)(workshop_validation_1.createWorkshopZodSchema), workshop_controller_1.default.updateWorkshop);
