 ...
 */
router.post("/create-level", adminCrudLimiter, checkAuth(UserRole.ADMIN, UserRole.SUPER_ADMIN), validateRequest(createLevelZodSchema), WorkshopController.createLevel);
/**
 * @openapi
 * /workshop/levels/{id}:
 *   patch:
 ...
 *         $ref: "#/components/responses/NotFoundError"
 */
router.patch("/levels/:id", adminCrudLimiter, checkAuth(UserRole.ADMIN, UserRole.SUPER_ADMIN), validateRequest(updateLevelZodSchema), WorkshopController.updateLevel);
/**
 * @openapi
 * /workshop/levels/{id}:
 *   delete:
 ...
 *         $ref: "#/components/responses/ForbiddenError"
 */
router.delete("/levels/:id", adminCrudLimiter, checkAuth(UserRole.ADMIN, UserRole.SUPER_ADMIN), WorkshopController.deleteLevel);
// workshop routes
/**
 * @openapi
 * /workshop:
 ...
 *         $ref: "#/components/responses/ConflictError"
 */
router.post("/create", adminCrudLimiter, checkAuth(UserRole.ADMIN, UserRole.SUPER_ADMIN, UserRole.INSTRUCTOR), multerUpload.array("files", 10), validateRequest(createWorkshopZodSchema), WorkshopController.createWorkshop);
/**
 * @openapi
 * /workshop/{id}:
 *   patch:
 ...
 *         $ref: "#/components/responses/ForbiddenError"
 */
router.delete("/:id", adminCrudLimiter, checkAuth(UserRole.ADMIN, UserRole.SUPER_ADMIN, UserRole.INSTRUCTOR), WorkshopController.deleteWorkshop);
