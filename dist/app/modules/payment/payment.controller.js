...
const initPayment = catchAsync(async (req, res) => {
    ...
    const result = await PaymentService.initPayment(enrollmentId, tokenUser.userId);
    sendResponse(res, {
...
const getInvoiceDownloadUrl = catchAsync(async (req, res) => {
    ...
    const tokenUser = req.user;
    const invoiceUrl = await PaymentService.getInvoiceDownloadUrl(paymentId, tokenUser.userId, tokenUser.role);
    sendResponse(res, {
        success: true,
        statusCode: StatusCodes.OK,
