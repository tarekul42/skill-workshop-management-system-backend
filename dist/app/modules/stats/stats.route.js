 ...
 */
router.get("/enrollment", checkAuth(UserRole.ADMIN, UserRole.SUPER_ADMIN), adminCrudLimiter, StatsController.getEnrollmentStatus);
/**
 * @openapi
 * /stats/payment:
 *   get:
 ...
 *         $ref: "#/components/responses/InternalServerError"
 */
router.get("/payment", checkAuth(UserRole.ADMIN, UserRole.SUPER_ADMIN), adminCrudLimiter, StatsController.getPaymentStatus);
/**
 * @openapi
 * /stats/users:
 *   get:
 ...
 *         $ref: "#/components/responses/InternalServerError"
 */
router.get("/users", checkAuth(UserRole.ADMIN, UserRole.SUPER_ADMIN), adminCrudLimiter, StatsController.getUserStats);
/**
 * @openapi
 * /stats/workshops:
 *   get:
