...
const getUsersStats = async () => {
    ...
    const [totalUsers, totalActiveUsers, totalInActiveUsers, totalBlockedUsers, newUsersInLastSevenDays, newUsersInLastThirtyDays, usersByRole,] = await Promise.all([
        totalUsersPromise,
...
const getWorkshopStats = async () => {
    ...
    const [totalWorkshop, totalWorkshopByLevel, avgWorkshopPrice, totalWorkshopByCategory, totalHighestEnrolledWorkshop,] = await Promise.all([
...
const getEnrollmentStats = async () => {
    ...
    const [totalEnrollment, totalEnrollmentByStatus, enrollmentsPerWorkshop, avgGuestCountPerEnrollment, enrollmentsLastSevenDays, enrollmentsLastThirtyDays, totalEnrollmentByUniqueUsers,] = await Promise.all([
...
const getTrends = async () => {
    ...
    const [enrollmentTrends, dailyEnrollments, revenueTrends, userTrends,] = await Promise.all([
