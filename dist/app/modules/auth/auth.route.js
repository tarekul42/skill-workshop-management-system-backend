...
router.get("/google/callback", rateLimiter_1.authLimiter, passport_1.default.authenticate("google", { failureRedirect: "/login" }), auth_controller_1.default.googleCallback);
