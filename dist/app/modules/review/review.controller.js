...
const getWorkshopReviews = catchAsync(async (req, res) => {
    const workshopId = parseStringParam(req.params.workshopId, "workshopId");
    const page = parseInt(req.query.page) || 1;
    const limit = parseInt(req.query.limit) || 10;
    const sort = req.query.sort || "newest";
    const result = await ReviewService.getWorkshopReviews(workshopId, page, limit, sort);
    sendResponse(res, {
...
const getWorkshopReviewStats = catchAsync(async (req, res) => {
    const workshopId = parseStringParam(req.params.workshopId, "workshopId");
...
const updateReview = catchAsync(async (req, res) => {
    ...
    const payload = req.body;
    const result = await ReviewService.updateReview(reviewId, payload, userId, userRole);
    sendResponse(res, {
        statusCode: StatusCodes.OK,
        success: true,
...
const getUserReviewForWorkshop = catchAsync(async (req, res) => {
    const userId = req.user.userId;
    const workshopId = parseStringParam(req.params.workshopId, "workshopId");
    const result = await ReviewService.getUserReviewForWorkshop(workshopId, userId);
    sendResponse(res, {
        statusCode: StatusCodes.OK,
        success: true,
